...
// CDC Tx
__idata uint8_t          CDC1_PutCharBuf[CDC_PUTCHARBUF_LEN]; // The buffer for CDC1_PutChar
__idata volatile uint8_t CDC1_PutCharBuf_Last  = 0;           // Point to the last char in the buffer
__idata volatile uint8_t CDC1_PutCharBuf_First = 0;           // Point to the first char in the buffer
__idata volatile uint8_t CDC1_Tx_Busy          = 0;
__idata volatile uint8_t CDC1_Tx_Full          = 0;

__idata uint8_t          CDC2_PutCharBuf[CDC_PUTCHARBUF_LEN]; // The buffer for CDC2_PutChar
__idata volatile uint8_t CDC2_PutCharBuf_Last  = 0;           // Point to the last char in the buffer
__idata volatile uint8_t CDC2_PutCharBuf_First = 0;           // Point to the first char in the buffer
__idata volatile uint8_t CDC2_Tx_Busy          = 0;
__idata volatile uint8_t CDC2_Tx_Full          = 0;

// CDC Rx
__idata volatile uint8_t CDC1_Rx_Pending = 0; // Number of bytes need to be processed before accepting more USB packets
__idata volatile uint8_t CDC1_Rx_CurPos  = 0;

__idata volatile uint8_t CDC2_Rx_Pending = 0; // Number of bytes need to be processed before accepting more USB packets
__idata volatile uint8_t CDC2_Rx_CurPos  = 0;
...
{
  uint8_t        cur_byte;
  static uint8_t checksum = 0, cdc1_prev_byte = 0x00, cdc2_prev_byte = 0x00;
